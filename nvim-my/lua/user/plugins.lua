...
return packer.startup(function(use)
	...
	use("nvim-treesitter/nvim-treesitter", { run = ":TSUpdate" }) -- Treesitter, syntax parser
	...
	-- Colorschemes
	-- use "LunarVim/Colorschemes"         -- collection of different colorschemes, 'lunar' colorscheme doesn't work with my nvim config for some reason
