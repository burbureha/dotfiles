...
static Key keys[] = {
	...
	{ MODKEY,                       XK_j,      focusstack,     {.i = +1 } }, 												 // Move up the stack of windows
	{ MODKEY,                       XK_k,      focusstack,     {.i = -1 } }, 												 // Move down the stack of windows
	...
	{ MODKEY,                       XK_Left,   setmfact,       {.f = -0.05} },                       // Make master window smaller
	{ MODKEY,                       XK_Right,  setmfact,       {.f = +0.05} }, 										   // Make master window bigger
