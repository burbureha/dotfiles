import { __exports as types } from '../../../node_modules/_virtual/types.js';
import './helpers/errorUtil.js';
import './helpers/parseUtil.js';
import './helpers/util.js';
import './ZodError.js';
import { __exports as errorUtil } from '../../../node_modules/_virtual/errorUtil.js';
import { __exports as parseUtil } from '../../../node_modules/_virtual/parseUtil.js';
import { __exports as util } from '../../../node_modules/_virtual/util.js';
import { __exports as ZodError } from '../../../node_modules/_virtual/ZodError.js';
...
class ZodString extends ZodType {
  constructor() {
    ...
    this.trim = () => new ZodString({ ...this._def,
  ...
  _parse(input) {
    ...
    function makeArgsIssue(args, error) {
      return parseUtil_1.makeIssue({
        data: args,
        path: ctx.path,
        errorMaps: [ctx.common.contextualErrorMap, ctx.schemaErrorMap, ZodError_1.getErrorMap(), ZodError_1.defaultErrorMap].filter(x => !!x),
        issueData: {
  ...
  _parse(input) {
    ...
    if (effect.type === "transform") {
      if (ctx.common.async === false) {
        ...
        if (!parseUtil_1.isValid(base)) return base;
        ...
        return this._def.schema._parseAsync({
          ...
          if (!parseUtil_1.isValid(base)) return base; // if (base.status === "aborted") return INVALID;
          // if (base.status === "dirty") {
          //   return { status: "dirty", value: base.value };
          // }
