...
const attributeChangedCallback = (element, attributeName, oldValue) => {
  ...
  const {
    active,
    observers
  } = ownerDocument[MUTATION_OBSERVER];
  ...
  constructor(ownerDocument) {
    ...
    this.class = class MutationObserver {
      ...
      observe(target, options = {
        ...
        characterData: false // TODO: not implemented yet
        // characterDataOldValue: false

      }) {
        if ('attributeOldValue' in options || 'attributeFilter' in options) options.attributes = true; // if ('characterDataOldValue' in options)
