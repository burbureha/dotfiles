import { ATTRIBUTE_NODE, DOCUMENT_TYPE_NODE, ELEMENT_NODE, COMMENT_NODE, TEXT_NODE, NODE_END } from './constants.js';
...
const loopSegment = ({
  ...
  if (typeof value === 'number' && value < 0) json[last] += NODE_END;else json.push(NODE_END);
};
