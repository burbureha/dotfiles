  ...
  compareDocumentPosition(target) {
    ...
    if (this !== target) {
      ...
      if (self < other) {
        ...
        if (childNodes.indexOf(this) < childNodes.indexOf(target)) result += DOCUMENT_POSITION_FOLLOWING;else result += DOCUMENT_POSITION_PRECEDING;
      }
