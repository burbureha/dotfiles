import { commonjsGlobal } from '../../../node_modules/_virtual/_commonjsHelpers.js';
import { f as flexsearch_bundle } from '../../../node_modules/_virtual/flexsearch.bundle.js';
...
(function _f(self) {
  ...
  function fa(a, b) {
    ...
    for (let h = 0, k, m; h < d; h++) k = c[h], (m = a[k]) ? (e[g++] = F(b ? "(?!\\b)" + k + "(\\b|_)" : k), e[g++] = m) : f += (f ? "|" : "") + k;
  ...
  function ma(a, b, c, d) {
    ...
    for (let m = e - 1; 0 <= m; m--) {
      ...
      for (let l = 0; l < w; l++) {
        ...
        if (z) for (let B = 0, A, y; B < z; B++) if (y = p[B], g) {
          if (g[y]) {
            if (!m) if (c) c--;else if (f[k++] = y, k === b) return f;
            if (m || d) q[y] = 1;
            r = !0;
          }

          if (d && (A = (h[y] || 0) + 1, h[y] = A, A < e)) {
            const H = d[A - 2] || (d[A - 2] = []);
            H[H.length] = y;
          }
        } else q[y] = 1;
    ...
    if (d) for (let m = d.length - 1, n, w; 0 <= m; m--) {
      ...
      for (let q = 0, r; q < w; q++) if (r = n[q], !g[r]) {
        if (c) c--;else if (f[k++] = r, k === b) return f;
        g[r] = 1;
      }
    }
    return f;
        ...
        for (let r = 0; r < d; r++) {
          ...
          if (l && e >= this.B && (w || !n[l])) {
            ...
            switch (this.G) {
              ...
              case "reverse":
                if (1 < e) {
                  for (h = e - 1; 0 < h; h--) g = l[h] + g, g.length >= this.B && M(this, n, g, L(q, d, r, e, h), a, c);
              ...
              case "forward":
                if (1 < e) {
                  for (h = 0; h < e; h++) g += l[h], g.length >= this.B && M(this, n, g, f, a, c);

                  break;
                }

              default:
                if (this.C && (f = Math.min(f / this.C(b, l, r) | 0, q - 1)), M(this, n, l, f, a, c), w && 1 < d && r < d - 1) for (e = v(), g = this.A, f = l, h = Math.min(w + 1, d - r), e[f] = 1, k = 1; k < h; k++) if ((l = b[this.F ? d - 1 - r - k : r + k]) && l.length >= this.B && !e[l]) {
                  e[l] = 1;
                  const p = this.l && l > f;
  ...
  function M(a, b, c, d, e, f, g) {
    let h = g ? a.h : a.map;
    if (!b[c] || g && !b[c][g]) a.s && (h = h[d]), g ? (b = b[c] || (b[c] = v()), b[g] = 1, h = h[g] || (h[g] = v())) : b[c] = 1, h = h[c] || (h[c] = []), a.s || (h = h[d] || (h[d] = [])), f && h.includes(e) || (h[h.length] = e, a.m && (a = a.register[e] || (a.register[e] = []), a[a.length] = h));
  }
  ...
  t.search = function (a, b, c) {
    ...
    if (a && (a = this.encode("" + a), e = a.length, 1 < e)) {
      ...
      for (let n = 0, w = 0, q; n < e; n++) if ((q = a[n]) && q.length >= this.B && !c[q]) if (this.s || f || this.map[q]) k[w++] = q, c[q] = 1;else return d;
    ...
    for (let n, w; c < e; c++) {
      w = a[c];
      h ? (n = sa(this, d, f, b, g, 2 === e, w, m), f && !1 === n && d.length || (m = w)) : n = sa(this, d, f, b, g, 1 === e, w);
      if (n) return n;
  ...
  function sa(a, b, c, d, e, f, g, h) {
    ...
    if (m) {
      ...
      for (let q = 0, r = 0, l, p; q < w; q++) if (l = m[q]) if (a.s && (l = ua(l, g, h, a.l)), e && l && f && (p = l.length, p <= e ? (e -= p, l = null) : (l = l.slice(e), e = 0)), l && (k[n++] = l, f && (r += l.length, r >= d))) break;
  ...
  t.remove = function (a, b) {
    ...
    if (c) {
      if (this.m) for (let d = 0, e; d < c.length; d++) e = c[d], e.splice(e.indexOf(a), 1);else N(this.map, a, this.D, this.s), this.depth && N(this.h, a, this.A, this.s);
  ...
  function N(a, b, c, d, e) {
    ...
    if (a.constructor === Array) {
      if (e) b = a.indexOf(b), -1 !== b ? 1 < a.length && (a.splice(b, 1), f++) : f++;else {
        e = Math.min(a.length, c);

        for (let g = 0, h; g < e; g++) if (h = a[g]) f = N(h, b, c, d, e), d || f || delete a[g];
      }
    } else for (let g in a) (f = N(a[g], b, c, d, e)) || delete a[g];
    return f;
  }
  ...
  t.export = function (a, b, c, d, e) {
    ...
    ra(a, b || this, c, f, d, e, g);
    return !0;
  };

  t.import = function (a, b) {
    if (b) switch (x(b) && (b = JSON.parse(b)), a) {
      case "cfg":
        this.s = !!b.opt;
        break;
  ...
  function O(a) {
    ...
    const c = "undefined" === typeof window && self.exports,
          d = this;
  ...
  function Q(a) {
    ...
    for (let e = 0, f, g; e < d.length; e++) f = d[e], x(f) || (g = f, f = f.field), g = C(g) ? Object.assign({}, a, g) : a, this.o && (c[f] = new O(g), c[f].o || (this.o = !1)), this.o || (c[f] = new K(g, this.register)), this.K[e] = S(f, this.A), this.h[e] = f;

    if (this.C) for (a = b.store, x(a) && (a = [a]), b = 0; b < a.length; b++) this.C[b] = S(a[b], this.A);
    this.index = c;
  }
  ...
  function T(a, b) {
    if (x(b)) a = a[b];else for (let c = 0; a && c < b.length; c++) a = a[b[c]];
    return a;
  }

  function U(a, b, c, d, e) {
    a = a[e];
    if (d === c.length - 1) b[e] = a;else if (a) if (a.constructor === Array) for (b = b[e] = Array(a.length), e = 0; e < a.length; e++) U(a, b, c, d, e);else b = b[e] || (b[e] = v()), e = c[++d], U(a, b, c, d, e);
  }
  ...
  function V(a, b, c, d, e, f, g, h) {
    if (a = a[g]) if (d === b.length - 1) {
      ...
      e.add(f, a, h, !0);
    } else if (a.constructor === Array) for (g = 0; g < a.length; g++) V(a, b, c, d, e, f, g, h);else g = b[++d], V(a, b, c, d, e, f, g, h);
  }
  ...
  t.add = function (a, b, c) {
    ...
    if (b && (a || 0 === a)) {
      ...
      if (this.I) {
        ...
        for (let f = 0, g, h; f < d.length; f++) if (g = d[f], !e[g] && (e[g] = 1, h = this.l[g] || (this.l[g] = []), !c || !h.includes(a))) if (h[h.length] = a, this.m) {
      ...
      if (this.store && (!c || !this.store[a])) {
        ...
        if (this.C) {
          ...
          for (let e = 0, f; e < this.C.length; e++) f = this.C[e], x(f) ? d[f] = b[f] : U(b, d, f, 0, f[0]);
        }
  ...
  t.search = function (a, b, c, d) {
    ...
    let e = [],
        ...
        w,
        q = 0;
    if (c) if (c.constructor === Array) k = c, c = null;else {
      a = c.query || a;
      ...
      if (m && (x(m) && (m = [m]), !a)) {
        for (let l = 0, p; l < m.length; l++) if (p = ya.call(this, m[l], b, w, h)) e[e.length] = p, q++;
    ...
    for (let l = 0, p, z, B; l < k.length; l++) {
      let A;
      z = k[l];
      x(z) || (A = z, z = A.field, a = A.query || a, b = A.limit || b);
      if (r) r[l] = this.index[z].searchAsync(a, b, A || c);else {
        ...
        if (B) f[q] = z, e[q++] = p;else if (n) return [];
      }
    }
  ...
  function Da(a) {
    ...
    if (a) {
      ...
      for (let e = 0, f, g = 0; e < d; e++) if ((a = c[e]) && (!this.filter || !this.filter[a])) {
        f = a[0];
        let h = Ga[f] || f,
            k = h;
