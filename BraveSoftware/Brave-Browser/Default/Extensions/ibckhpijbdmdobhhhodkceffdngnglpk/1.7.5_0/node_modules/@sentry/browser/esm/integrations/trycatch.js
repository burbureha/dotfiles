...
import { fill, getOriginalFunction } from '../../node_modules/@sentry/utils/esm/object.js';
import { getFunctionName } from '../../node_modules/@sentry/utils/esm/stacktrace.js';
...
function _wrapEventTarget(target) {
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  const globalObject = WINDOW; // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access

  const proto = globalObject[target] && globalObject[target].prototype; // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access, no-prototype-builtins
