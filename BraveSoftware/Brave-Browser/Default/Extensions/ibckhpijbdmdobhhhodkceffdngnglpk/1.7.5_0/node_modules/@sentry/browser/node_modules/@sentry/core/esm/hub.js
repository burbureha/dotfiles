...
import { isNodeEnv } from '../../utils/esm/node.js';
...
function getCurrentHub() {
  ...
  const registry = getMainCarrier(); // If there's no hub, or its an old API, assign a new one
...
function getHubFromActiveDomain(registry) {
  try {
    ...
    const activeDomain = sentry && sentry.extensions && sentry.extensions.domain && sentry.extensions.domain.active; // If there's no active domain, just return global hub
